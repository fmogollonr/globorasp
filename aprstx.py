...
gps_message=getGPSLine(gps_file)
message_tmp=gps_message.split(":")[1]
gps_parts=message_tmp.split(";")
print(gps_parts)
lon=gps_parts[0]
lat=gps_parts[1]
hour=gps_parts[2]
...
message=callsign+">WORLD,WIDE2-2:!"+newLat+"N/"+newLong+"E/A="+alt+"/"+str(time[0])+"/"+msg
print(message)
