...
# Modes are
# files=1
# reads images and audio files from folder and transmits them
# Lee archivos de imagen y de audio de un directorio y los transmite a través de sstv
# camera=0
# Captures images from camera and gps position and transmits them by sstv
# Captura imagenes con la cámara de la raspberry y las transmite usando sstv
mode=1
...
#/home/felipe/Documents/radio/globorasp/tmp
#home="/home/pi/sstv/"
home="/home/felipe/Documents/radio/globorasp/tmp/"
mkdir -p $home
...
do
	...
	then
		...
		/bin/bash convert_images.sh $home $sstv_mode
	fi
	if [[ mode == "0" ]]
	then 
	...
	then
		...
		for audio in $home"/*.wav"
		do
			aplay $audio
			sleep $intervalo2
		done
		for audio in $home"/*.mp3"
		do
			mpg321 $audio
			sleep $intervalo2
		done
